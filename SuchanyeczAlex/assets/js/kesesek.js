function adatok() {
    ...
    // Számok 10 és 1000 között
    const adat1 = Math.floor(Math.random() * 1000) + 10;
    const adat2 = Math.floor(Math.random() * 1000) + 10;
    const adat3 = Math.floor(Math.random() * 1000) + 10;
